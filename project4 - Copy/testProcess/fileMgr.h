...
/*
    ...
    int copyFilesToWDir(std::string& src,std::string& desti);
...
/*
    Maintenance History
    ===================
    ver 2.0 : 24 April 2012
      - Added new function which shall copy the file from source directory to destination returning the 
