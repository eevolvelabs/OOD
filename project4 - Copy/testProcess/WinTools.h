...
namespace Win32Tools
{
  ...
  template <>
  void SystemError<std::string>::ThrowString(const std::string msg, const std::string file, int line) 
  {
  ...
  template <>
  void SystemError<std::wstring>::ThrowString(const std::wstring msg, const std::wstring file, int line) 
  {
  ...
  template <>
  std::string SystemError<std::string>::GetLastMsg() 
  {
  ...
  template <>
  std::wstring SystemError<std::wstring>::GetLastMsg() 
  {
    // ask system what type of error occurred
  ...
  template <typename stdStr>
  bool Directory<stdStr>::SetRestorePath(const stdStr& path)
  {
  ...
  template <typename stdStr>
  bool Directory<stdStr>::DirectoryExists(const stdStr& path)
  {
  ...
  template <>
  bool Directory<std::string>::CreateDirectory(const std::string& path)
  {
    return (::CreateDirectoryA(path.c_str(),0) != 0);
  }
  template <>
  bool Directory<std::wstring>::CreateDirectory(const std::wstring& path)
  {
  ...
  template <>
  bool Directory<std::string>::RemoveDirectory(const std::string &path, bool confirm)
  {
    return (::RemoveDirectoryA(path.c_str()) != 0);
  }
  template <>
  bool Directory<std::wstring>::RemoveDirectory(const std::wstring &path, bool confirm)
  {
  ...
  template <>
  std::string Directory<std::string>::GetCurrentDirectory()
  {
  ...
  template <>
  std::wstring Directory<std::wstring>::GetCurrentDirectory()
  {
    const size_t BufSize = 256;
  ...
  template <>
  bool Directory<std::string>::SetCurrentDirectory(const std::string& path)
  {
    return (::SetCurrentDirectoryA(path.c_str()) != 0);
  }
  template <>
  bool Directory<std::wstring>::SetCurrentDirectory(const std::wstring& path)
  {
  ...
  template <typename stdStr>
  std::vector<stdStr> Directory<stdStr>::GetFiles(const stdStr& path, const stdStr& pattern)
  {
  ...
  template <typename stdStr>
  std::vector<stdStr> Directory<stdStr>::GetFiles(const stdStr& pattern)
  {
  ...
  template <>
  std::vector<std::string> Directory<std::string>::GetFiles()
  {
    return Directory<std::string>::GetFiles("*.*");
  }

  template <>
  std::vector<std::wstring> Directory<std::wstring>::GetFiles()
  {
  ...
  template <>
  std::vector<std::string> Directory<std::string>::GetDirectories(const std::string& path, const std::string& pattern)
  {
  ...
  template <>
  std::vector<std::wstring> Directory<std::wstring>::GetDirectories(const std::wstring& path, const std::wstring& pattern)
  {
  ...
  template <typename stdStr>
  std::vector<stdStr> Directory<stdStr>::GetDirectories(const stdStr& pattern)
  {
  ...
  template <>
  std::vector<std::string> Directory<std::string>::GetDirectories()
  {
    return Directory<std::string>::GetDirectories("*.*");
  }

  template <>
  std::vector<std::wstring> Directory<std::wstring>::GetDirectories()
  {
  ...
  template <typename stdStr>
  std::vector<FileInfo<stdStr>> Directory<stdStr>::GetFileInfos(const stdStr& path, const stdStr& pattern)
  {
  ...
  template <typename stdStr>
  std::vector<FileInfo<stdStr>> Directory<stdStr>::GetFileInfos(const stdStr& pattern)
  {
  ...
  template <>
  std::vector<FileInfo<std::string>> Directory<std::string>::GetFileInfos()
  {
    return Directory<std::string>::GetFileInfos(GetCurrentDirectory(),"*.*");
  }

  template <>
  std::vector<FileInfo<std::wstring>> Directory<std::wstring>::GetFileInfos()
  {
  ...
  template <>
  bool Directory<std::string>::CopyFiles(
  ...
  template <>
  bool Directory<std::wstring>::CopyFiles(
  ...
  template <typename stdStr>
  stdStr Path<stdStr>::toLower(const stdStr& src)
  {
    stdStr temp;
  ...
  template <typename stdStr>
  stdStr Path<stdStr>::toUpper(const stdStr& src)
  {
    stdStr temp;
    for(size_t i=0; i<src.length(); ++i)
      temp += toupper(src[i]);
  ...
  template <>
  std::string Path<std::string>::getName(const std::string &fileSpec)
  {
  ...
  template <>
  std::wstring Path<std::wstring>::getName(const std::wstring &fileSpec)
  {
  ...
  template <typename stdStr>
  stdStr Path<stdStr>::getExt(const stdStr& fileSpec)
  {
  ...
  template <>
  std::string Path<std::string>::getPath(const std::string &fileSpec)
  {
    size_t pos = fileSpec.find_last_of("/");
    if(pos >= fileSpec.length())
      pos = fileSpec.find_last_of("\\");
  ...
  template <>
  std::wstring Path<std::wstring>::getPath(const std::wstring &fileSpec)
  {
    size_t pos = fileSpec.find_last_of(L"/");
    if(pos >= fileSpec.length())
      pos = fileSpec.find_last_of(L"\\");
  ...
  template <>
  std::string Path<std::string>::getFullPath(const std::string &fileSpec)
  {
    const size_t BufSize = 256;
    char buffer[BufSize];
  ...
  template <>
  std::wstring Path<std::wstring>::getFullPath(const std::wstring &fileSpec)
  {
    const size_t BufSize = 256;
    wchar_t buffer[BufSize];
  ...
  template <>
  std::string Path<std::string>::fileSpec(const std::string &path, const std::string &name)
  {
    std::string fs;
  ...
  template <>
  std::wstring Path<std::wstring>::fileSpec(const std::wstring &path, const std::wstring &name)
  {
    std::wstring fs;
    size_t len = path.size();
  ...
  template <typename stdStr>
  void FileHandler<stdStr>::setReadPath(const stdStr& path)
  {
    _ReadPath = path;
  }
  ...
  template <typename stdStr>
  void FileHandler<stdStr>::setWritePath(const stdStr& path)
  {
    _WritePath = path;
  }
  ...
  template <>
  bool FileHandler<std::string>::openFileReader(const std::string& file)
  {
  ...
  template <>
  bool FileHandler<std::wstring>::openFileReader(const std::wstring& file)
  {
  ...
  template <>
  bool FileHandler<std::string>::openFileWriter(const std::string& file)
  {
  ...
  template <>
  bool FileHandler<std::wstring>::openFileWriter(const std::wstring& file)
  {
  ...
  template <typename stdStr>
  size_t FileHandler<stdStr>::getBlock(byte_* pBlock, size_t size)
  {
    DWORD numBytesRead;
  ...
  template <typename stdStr>
  size_t FileHandler<stdStr>::putBlock(byte_* pBlock, size_t size)
  {
  ...
  template <typename stdStr>
  void FileHandler<stdStr>::closeFileReader()
  {
  ...
  template <typename stdStr>
  void FileHandler<stdStr>::closeFileWriter()
  {
  ...
  template <typename stdStr>
  stdStr FileHandler<stdStr>::blockToString(byte_* pBlock, size_t size)
  {
    stdStr temp;
