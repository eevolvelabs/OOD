...
namespace Win32Tools
{
  ...
  template <>
  inline std::string FileInfo<std::string>::name() const { 
    return Convert::ToString(data.cFileName); 
  }
  ...
  {
    return (strcmp(Convert::ToString(data.cFileName).c_str(),Convert::ToString(fd.data.cFileName).c_str()) == -1);
  }
  ...
  {  
    return (strcmp(Convert::ToString(data.cFileName).c_str(),Convert::ToString(fi.data.cFileName).c_str()) == 0);
  }
  ...
  //template <>
  //std::string ConvToASCII(const std::string& s)
  //{
  //  return s;
  //}

  //template <>
  //std::string ConvToASCII(const std::wstring& s)
  //{
  //  std::string temp;
  ...
  //template <>
  //std::wstring ConvToWide(const std::string& s)
  //{
  //  std::wstring temp;
  //  for(size_t i=0; i<s.size(); ++i)
  ...
  //template <>
  //std::wstring ConvToWide(const std::wstring& s)
  //{
  //  return s;
  //}
  //----< void constructor >-------------------------------------
  ...
  template <typename stdStr>
  FileInfo<stdStr>::FileInfo(const stdStr &path) 
          : showSeconds_(false), showTime_(true), showDate_(true),
            showSize_(true), showAttrib_(true)
  {
    _handle = INVALID_HANDLE_VALUE;
  ...
  template <>
  FileInfo<std::string>::FileInfo(const FileInfo<std::string> &fi) 
  ...
  template <>
  FileInfo<std::wstring>::FileInfo(const FileInfo<std::wstring> &fi) 
  : showSeconds_(fi.showSeconds_), showTime_(fi.showTime_),
  showDate_(fi.showDate_), showSize_(fi.showSize_), showAttrib_(fi.showAttrib_)
  {
  ...
  template <typename stdStr>
  FileInfo<stdStr>::~FileInfo() { setPath(_OrigPath); }

  //----< assignment operator >----------------------------------

  template <>
  FileInfo<std::string>& FileInfo<std::string>::operator=(const FileInfo<std::string> &fi) 
  {
  ...
  template <>
  FileInfo<std::wstring>& FileInfo<std::wstring>::operator=(const FileInfo<std::wstring> &fi) 
  {
    if(this == &fi) return *this;
    wdata.dwFileAttributes    = fi.wdata.dwFileAttributes;
    wdata.ftCreationTime      = fi.wdata.ftCreationTime;  
  ...
  template <>
  unsigned long int FileInfo<std::string>::size() const 
  {
  ...
  template <>
  unsigned long int FileInfo<std::wstring>::size() const 
  {
  ...
  template <>
  bool FileInfo<std::string>::smaller(const FileInfo<std::string> &fi) const 
  {  
    DWORDLONG myDWL = (static_cast<DWORDLONG>(data.nFileSizeHigh) << 32);
    myDWL += data.nFileSizeLow & 0xFFFFFFFF;
  ...
  template <>
  bool FileInfo<std::wstring>::smaller(const FileInfo<std::wstring> &fi) const 
  {  
    DWORDLONG myDWL = (static_cast<DWORDLONG>(wdata.nFileSizeHigh) << 32);
    myDWL += wdata.nFileSizeLow & 0xFFFFFFFF;
  ...
  template <>
  bool FileInfo<std::string>::larger(const FileInfo<std::string> &fi) const 
  {  
    DWORDLONG myDWL = (static_cast<DWORDLONG>(data.nFileSizeHigh) << 32);
    myDWL += data.nFileSizeLow & 0xFFFFFFFF;
    DWORDLONG fiDWL = (static_cast<DWORDLONG>(fi.data.nFileSizeHigh) << 32);
  ...
  template <>
  bool FileInfo<std::wstring>::larger(const FileInfo<std::wstring> &fi) const 
  {  
    DWORDLONG myDWL = (static_cast<DWORDLONG>(wdata.nFileSizeHigh) << 32);
    myDWL += wdata.nFileSizeLow & 0xFFFFFFFF;
    DWORDLONG fiDWL = (static_cast<DWORDLONG>(fi.wdata.nFileSizeHigh) << 32);
  ...
  //
  template <>
  FILETIME FileInfo<std::string>::getFILETIME()
  {
    FILETIME lft;
  ...
  template <>
  FILETIME FileInfo<std::wstring>::getFILETIME()
  {
    FILETIME lft;
  ...
  //
  template <typename stdStr>
  int FileInfo<stdStr>::compareFileTime(FILETIME& ft)
  {
  ...
  template <>
  SYSTEMTIME FileInfo<std::string>::DateAndTime() const 
  {
   SYSTEMTIME st;
   FILETIME  lft;
   FileTimeToLocalFileTime(&data.ftLastWriteTime,&lft);
  ...
  template <>
  SYSTEMTIME FileInfo<std::wstring>::DateAndTime() const 
  {
   SYSTEMTIME st;
   FILETIME  lft;
   FileTimeToLocalFileTime(&wdata.ftLastWriteTime,&lft);
  ...
  template <>
  std::string FileInfo<std::string>::date() const 
  {
  ...
  template <>
  std::wstring FileInfo<std::wstring>::date() const 
  {
    SYSTEMTIME st = DateAndTime();
    std::wstring date;
    date.resize(0);
  ...
  template <>
  std::string FileInfo<std::string>::time() const 
  {
    SYSTEMTIME st = DateAndTime();
    std::string time;
    std::string AMPM = "am";
  ...
  template <>
  std::wstring FileInfo<std::wstring>::time() const 
  {
    SYSTEMTIME st = DateAndTime();
    std::wstring time;
  ...
  template <typename stdStr>
  stdStr FileInfo<stdStr>::attributes() const 
  {
    stdStr temp;
    if(isArchive()   ) temp += 'A';
  ...
  template <>
  bool FileInfo<std::string>::isArchive() const 
  { 
    return (data.dwFileAttributes & FILE_ATTRIBUTE_ARCHIVE);
  }

  template <>
  bool FileInfo<std::wstring>::isArchive() const 
  { 
  ...
  template <>
  bool FileInfo<std::string>::isCompressed() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_COMPRESSED); 
  }

  template <>
  bool FileInfo<std::wstring>::isCompressed() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isDirectory() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY); 
  }

  template <>
  bool FileInfo<std::wstring>::isDirectory() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isEncrypted() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_ENCRYPTED); 
  }

  template <>
  bool FileInfo<std::wstring>::isEncrypted() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isHidden() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_HIDDEN); 
  }

  template <>
  bool FileInfo<std::wstring>::isHidden() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isNormal() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_NORMAL); 
  }

  template <>
  bool FileInfo<std::wstring>::isNormal() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isOffLine() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_OFFLINE); 
  }

  template <>
  bool FileInfo<std::wstring>::isOffLine() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isReadOnly() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_READONLY); 
  }

  template <>
  bool FileInfo<std::wstring>::isReadOnly() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isSystem() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_SYSTEM); 
  }

  template <>
  bool FileInfo<std::wstring>::isSystem() const 
  {   
  ...
  template <>
  bool FileInfo<std::string>::isTemporary() const 
  {   
    return (data.dwFileAttributes & FILE_ATTRIBUTE_TEMPORARY); 
  }

  template <>
  bool FileInfo<std::wstring>::isTemporary() const 
  {   
  ...
  template <>
  void FileInfo<std::string>::showData(std::ostream &out, char ch, int width) const 
  {
    long save = out.flags();
  ...
  template <>
  void FileInfo<std::wstring>::showData(std::wostream &out, wchar_t ch, int width) const 
  {
    long save = out.flags();
    out.setf(std::ios::right, std::ios::adjustfield);
    if(showSize_)
  ...
  //
  template <>
  std::string FileInfo<std::string>::getPath() 
  {
    char buffer[256];
  ...
  template <>
  std::wstring FileInfo<std::wstring>::getPath() 
  {
    wchar_t buffer[256];
  ...
  template <>
  void FileInfo<std::string>::setPath(const std::string& s) 
  {
  ...
  template <>
  void FileInfo<std::wstring>::setPath(const std::wstring& s) 
  {
  ...
  template <>
  bool FileInfo<std::string>::firstFile(std::string path, const std::string& filePattern) 
  {
  ...
  template <>
  bool FileInfo<std::wstring>::firstFile(std::wstring path, const std::wstring& filePattern) 
  {
    if(_handle != INVALID_HANDLE_VALUE)
      closeFile();    // close any previous search
  ...
  template <typename stdStr>
  bool FileInfo<stdStr>::firstFile(const stdStr &filePattern) 
  {
    stdStr path = getPath();
  ...
  template <>
  bool FileInfo<std::string>::firstFile() 
  {
  ...
  template <>
  bool FileInfo<std::wstring>::firstFile() 
  {
  ...
  template <>
  bool FileInfo<std::string>::nextFile() 
  {
    if(_handle == INVALID_HANDLE_VALUE)
      return false;
  ...
  template <>
  bool FileInfo<std::wstring>::nextFile() 
  {
    if(_handle == INVALID_HANDLE_VALUE)
      return false;
  ...
  template <typename stdStr>
  void FileInfo<stdStr>::closeFile() {  FindClose(_handle); }
