...
/*
    ...
    thread ver 3.6 : 01 May 2004
    - added copy ctors and assignment operators to LLock
    thread ver 3.4 : 12 Apr 2004
    - added inline qualifier to synchOut constructor - EVERY definition
      in a header file MUST be either template or inline.  The omission
      was an oversight.
